...
2. 自我认知需要包含以下方面,每个方面中的具体条目可根据实际需要遵循分类逻辑增减:
  ...
  - 【经验记忆】逐条记录与用户相处过程中的重要事件及其时间,根据重要程度打分(0~1.0)。从情感或事实方面考虑重要性,在篇幅限制内尽可能多记录。即时评估,接近字数限制时,请总结合并一段时间内的经验,或逐渐淡出最不重要的事件。
...
2. 用户档案需要包含以下方面,每个方面中的具体条目可根据实际需要遵循分类逻辑增减:
  ...
  - 【经验记忆】用户在对话中透露的与其自身相关的重要事件及其时间,根据重要程度打分(0~1.0)。从情感或事实方面考虑重要性,在篇幅限制内尽可能多记录。即时评估,总结合并一段时间内的经验,或逐渐淡出最不重要的事件。
