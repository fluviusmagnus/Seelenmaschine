...
4. 保持客观准确的叙述风格
5. 这是相对稳定的认识,请适当取舍,不要一次性改变太多原有内容,控制在3000字以内
6. 如有较多重复相似的内容或过于冗长,除更新信息外,请对全文进行精简,合并类似的内容,略去次要的内容,但保持整体结构不变
7. 如有特别提示不可变更的部分,尤其是类似系统提示词的内容,请严格原样保留
8. 请只输出自我认知本身,前后都不要添加其他文字
