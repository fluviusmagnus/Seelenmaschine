...
class Config:
    ...
    TOOL_LLM_MAX_RESPONSE_CHARS: int = 12000
    TOOL_LLM_TRUNCATE_HEAD_CHARS: int = 6000
    TOOL_LLM_TRUNCATE_TAIL_CHARS: int = 4000
    MCP_TEXT_BLOCK_MAX_CHARS: int = 12000
    MCP_TEXT_BLOCK_TRUNCATE_HEAD_CHARS: int = 6000
    MCP_TEXT_BLOCK_TRUNCATE_TAIL_CHARS: int = 4000
    ...
    TOOL_EXECUTION_TIMEOUT_SECONDS: float = 180.0
    ...
    def _load_all_settings(cls) -> None:
        ...
        cls.MCP_TEXT_BLOCK_MAX_CHARS = cls._get_int("MCP_TEXT_BLOCK_MAX_CHARS", 12000)
        ...
        cls.TOOL_EXECUTION_TIMEOUT_SECONDS = cls._get_float(
            "TOOL_EXECUTION_TIMEOUT_SECONDS", 180.0
        )
        ...
        cls.SHELL_OUTPUT_HEAD_CHARS = cls._get_int("SHELL_OUTPUT_HEAD_CHARS", 6000)
