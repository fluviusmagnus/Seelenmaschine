...
class TelegramFiles:
    ...
    def extract_file_info_from_update(self, update: Update) -> Optional[Dict[str, Any]]:
    ...
    async def send_local_file(
        ...
        """Send a local file through Telegram and return the delivery method."""
