...
8. **Workspace Guidelines**: Your default workspace is `{Config.WORKSPACE_DIR.resolve()}`. Prefer absolute paths when referencing files in this workspace. Never reference files outside the workspace.
